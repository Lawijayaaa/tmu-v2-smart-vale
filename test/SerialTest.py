...
def testBatch():
    if relayTest:
        ...
        print("Write " + str(relayState) + " to Relay CH1 - Oil Temperature Trip (24-25)")
        print(writeRly)
        writeRly = client.write_coil(2, relayState, slave = 1)
        print("Write " + str(relayState) + " to Relay CH2  - Oil Pressure Trip (26-27)")
        print(writeRly)
        writeRly = client.write_coil(3, relayState, slave = 1)
        print("Write " + str(relayState) + " to Relay CH3 - Buzzer")
        print(writeRly)
        writeRly = client.write_coil(4, relayState, slave = 1)
        print("Write " + str(relayState) + " to Relay CH4 - Solenoid Valve")
        print(writeRly)
        writeRly = client.write_coil(5, relayState, slave = 1)
        print("Write " + str(relayState) + " to Relay CH5 - Oil Level Alarm (20 - 21)")
        print(writeRly)
        writeRly = client.write_coil(6, relayState, slave = 1)
        print("Write " + str(relayState) + " to Relay CH6 - Oil Temperature Alarm (22 - 23)")
        print(writeRly)
